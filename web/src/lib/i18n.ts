...
export const STRINGS = {
  en: {
    ...
    "study.sessionChanged": "This card changed elsewhere. Your study session has been refreshed.",
    ...
    "settings.backupCapacity": "Backups are limited to 10 MB. This backup was not created or imported; your library is unchanged.",
    ...
    "settings.ttsPrivacy": "Text-to-speech is provided by your browser/device speech engine and may use network-backed voices depending on your system.",
    "settings.cefrHeader": "Learner Level (CEFR)",
    "settings.cefrAuto": "Auto / Not set",
    "settings.storageStatusHeader": "Storage Durability",
    "settings.storageStatusPersisted": "Persistent (protected from eviction)",
    "settings.storageStatusBestEffort": "Best-effort (browser may evict under storage pressure)",
    "settings.storageRequestPersist": "Enable persistent storage",
    "settings.storagePersistSuccess": "Persistent storage granted.",
    "settings.storagePersistFailed": "Could not grant persistent storage.",
    ...
    "ai.inputBlank": "Input cannot be blank",
    "ai.inputTooLong": "Input is too long (maximum {0} characters)",
    "ai.messageTooLong": "Message is too long (maximum {0} characters)",
    "ai.cancelled": "Request cancelled",
  ...
  de: {
    ...
    "study.sessionChanged": "Diese Karte wurde an anderer Stelle geändert. Deine Lernsitzung wurde aktualisiert.",
    ...
    "settings.backupDownloaded": "Sicherung heruntergeladen.",
    ...
    "settings.backupCapacity": "Sicherungen sind auf 10 MB begrenzt. Diese Sicherung wurde weder erstellt noch importiert; deine Bibliothek bleibt unverändert.",
    ...
    "settings.ttsPrivacy": "Sprachausgabe nutzt die Sprach-Engine deines Browsers/Geräts und kann je nach System netzwerkgestützte Stimmen verwenden.",
    "settings.cefrHeader": "Lernniveau (GER)",
    "settings.cefrAuto": "Automatisch / Nicht festgelegt",
    "settings.storageStatusHeader": "Speicherbeständigkeit",
    "settings.storageStatusPersisted": "Beständig (vor Bereinigung geschützt)",
    "settings.storageStatusBestEffort": "Standard (Browser kann Speicher bei Platzmangel bereinigen)",
    "settings.storageRequestPersist": "Beständigen Speicher aktivieren",
    "settings.storagePersistSuccess": "Beständiger Speicher gewährt.",
    "settings.storagePersistFailed": "Beständiger Speicher konnte nicht aktiviert werden.",
    ...
    "ai.inputBlank": "Eingabe darf nicht leer sein",
    "ai.inputTooLong": "Eingabe ist zu lang (maximal {0} Zeichen)",
    "ai.messageTooLong": "Nachricht ist zu lang (maximal {0} Zeichen)",
    "ai.cancelled": "Anfrage abgebrochen",
